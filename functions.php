...
if ( ! function_exists( 'financial_empowerment_setup' ) ) :
	/**
	 ...
	 */
	function financial_empowerment_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on financial_empowerment, use a find and replace
		 * to change 'financial_empowerment' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'financial_empowerment' ),
		) );
...
add_action( 'after_setup_theme', 'financial_empowerment_setup' );
